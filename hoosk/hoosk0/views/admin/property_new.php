...
<div class="container-fluid">
  <div class="row">
        ...
        <div class="panel panel-default">
         ...
         <div class="panel-body">
           <div class="alert alert-info"><?php echo $this->lang->line('properties_new_required'); ?></div>
			...
			echo form_open_multipart(BASE_URL.'/admin/properties/new/add', $attr); ?>
      <!-- Sale Details Section -->
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title"><?php echo $this->lang->line('listing_details'); ?></h3>
        </div>
        <div class="panel-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="alert alert-danger ref-exists"><?php echo $this->lang->line('properties_ref_exists'); ?></div>

                <label class="control-label" for="agent_ref"><?php echo $this->lang->line('agent_ref'); ?> <i id="ref-new" class="fa fa-check icon-success"></i><span class="ref-exists"><i class="icon-danger fa fa-remove"></i></span></label>
                <div class="controls">
                  <?php 	$data = array(
                    'name'        => 'agent_ref',
                    'id'          => 'agent_ref',
                    'class'       => 'form-control',
                    'value'		=> set_value('agent_ref', '', FALSE)
                  );
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('channel_id', getDropdownOptions('channel'), set_value('channel_id', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('price_qualifier', getDropdownOptions('qualifier'), set_value('price_qualifier', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('published', $options, set_value('published', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('overseas', $options, set_value('overseas', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('property_type', getDropdownOptionsType('type'), set_value('property_type', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('status', getDropdownOptions('status'), set_value('status', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
            </div>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('new_home', $options, set_value('new_home', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('branch_id', getDropdownBranches(), set_value('branch_id', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php 	$data = array(
                    ...
                    'class'       => 'form-control',
                    'value'		=> set_value('principal_email_address', '', FALSE)
                  );
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('auto_email_updates', $options, set_value('auto_email_updates', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('auto_email_when_live', $options, set_value('auto_email_when_live', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
            </div>
      ...
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title"><?php echo $this->lang->line('address_details'); ?></h3>
        </div>
        <div class="panel-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="controls">
                  <?php 	$data = array(
                    ...
                    'id'          => 'display_address',
                    'class'       => 'form-control',
                    'value'		=> set_value('display_address', '', FALSE)
                  );
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <?php 	$data = array(
                    ...
                    'class'       => 'form-control',
                    'value'		=> set_value('house_name_number', '', FALSE)
                  );
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <?php 	$data = array(
                    ...
                    'id'          => 'address_2',
                    'class'       => 'form-control',
                    'value'		=> set_value('address_2', '', FALSE)
                  );
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <?php 	$data = array(
                    ...
                    'id'          => 'address_3',
                    'class'       => 'form-control',
                    'value'		=> set_value('address_3', '', FALSE)
                  );
                  ...
                  <div class="form-group">
                    ...
                    <div class="controls">
                      <?php 	$data = array(
                        ...
                        'id'          => 'postcode_1',
                        'class'       => 'form-control',
                        'value'		=> set_value('postcode_1', '', FALSE)
                      );
                  ...
                  <div class="form-group">
                    ...
                    <div class="controls">
                      <?php 	$data = array(
                        ...
                        'id'          => 'postcode_2',
                        'class'       => 'form-control',
                        'value'		=> set_value('postcode_2', '', FALSE)
                      );
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <?php 	$data = array(
                    ...
                    'id'          => 'latitude',
                    'class'       => 'form-control',
                    'value'		=> set_value('latitude', '', FALSE)
                  );
                  echo form_input($data); ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php 	$data = array(
                    ...
                    'id'          => 'longitude',
                    'class'       => 'form-control',
                    'value'		=> set_value('longitude', '', FALSE)
                  );
                  echo form_input($data); ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
      ...
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title"><?php echo $this->lang->line('property_details'); ?></h3>
        </div>
        <div class="panel-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('bedrooms', getNumberArray(8), set_value('bedrooms', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('bathrooms', getNumberArray(8), set_value('bathrooms', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('reception_rooms', getNumberArray(8), set_value('reception_rooms', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
            </div>
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <?php 	$data = array(
       						...
       						echo form_textarea($data, set_value('summary', '', FALSE)); ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="controls">
              ...
              echo form_textarea($data, set_value('description', '', FALSE)); ?>
            </div> <!-- /controls -->
          </div> <!-- /form-group -->
        </div>
      </div>
      ...
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title"><?php echo $this->lang->line('letting_details'); ?></h3>
        </div>
        <div class="panel-body">
          <div class="alert alert-info"><?php echo $this->lang->line('letting_required'); ?></div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('student_property', $options, set_value('student_property', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('house_flat_share', $options, set_value('house_flat_share', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php 	$data = array(
                    ...
                    'id'          => 'datetimepicker',
                    'class'       => 'form-control',
                    'value'		=> set_value('date_available', '', FALSE)
                  );
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('contract_months', getNumberArray(48), set_value('contract_months', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('minimum_term', getNumberArray(24), set_value('minimum_term', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('let_type', getDropdownOptions('lettype'), set_value('let_type', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('rent_frequency', getDropdownOptions('rentfrequency'), set_value('rent_frequency', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('furnished_type', getDropdownOptions('furnished'), set_value('furnished_type', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php 	$data = array(
                    ...
                    'class'       => 'form-control',
                    'value'		=> set_value('administration_fee', '', FALSE)
                  );
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('pets_allowed', $options, set_value('pets_allowed', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('smokers_considered', $options, set_value('smokers_considered', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('housing_benefit_considered', $options, set_value('housing_benefit_considered', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('sharers_considered', $options, set_value('sharers_considered', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('all_bills_inc', $options, set_value('all_bills_inc', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('oil_bill_inc', $options, set_value('oil_bill_inc', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('council_tax_inc', $options, set_value('council_tax_inc', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
            </div>
      ...
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title"><?php echo $this->lang->line('student_details'); ?></h3>
        </div>
        <div class="panel-body">
          <div class="alert alert-info"><?php echo $this->lang->line('student_required'); ?></div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('burglar_alarm', $options, set_value('burglar_alarm', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('washing_machine', $options, set_value('washing_machine', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('dishwasher', $options, set_value('dishwasher', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('water_bill_inc', $options, set_value('water_bill_inc', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('gas_bill_inc', $options, set_value('gas_bill_inc', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
            </div>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('electricity_bill_inc', $options, set_value('electricity_bill_inc', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('tv_licence_inc', $options, set_value('tv_licence_inc', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('sat_cable_tv_bill_inc', $options, set_value('sat_cable_tv_bill_inc', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
              <div class="form-group">
                ...
                <div class="controls">
                  <?php
                    echo form_dropdown('internet_bill_inc', $options, set_value('internet_bill_inc', '', FALSE), 'class="form-control"');
                   ?>
                </div> <!-- /controls -->
              </div> <!-- /form-group -->
            </div>
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        <div class="alert alert-info"><?php echo $this->lang->line('rightmoveIntro'); ?></div>
        ...
        <div class="form-group">
          ...
          <div class="controls">
            <?php
              echo form_dropdown('rightmoveStatus', $options, set_value('rightmoveStatus', '', FALSE), 'class="form-control"');
             ?>
          </div> <!-- /controls -->
        </div> <!-- /form-group -->
