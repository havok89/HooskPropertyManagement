...
<div id="wrapper">
      ...
      <li class="dropdown <?php if ($current == "posts") { echo "active"; } ?>">
        ...
        <li class="dropdown <?php if ($current == "properties") { echo "active"; } ?>">
              <a href="javascript:;" data-toggle="collapse" data-target="#propertiesmenu"> <i class="fa fa-home"> </i> <span><?php echo $this->lang->line('nav_properties'); ?></span> <i class="fa fa-fw fa-caret-down"></i></a>
              <ul id="propertiesmenu" class="collapse<?php if ($current == "properties") { echo " in"; } ?>">
                <li<?php if (($current == "properties")&&($this->uri->segment(3)=="")) { echo ' class="active"'; } ?>><a href="/admin/properties"><?php echo $this->lang->line('nav_properties_all'); ?></a></li>
                <li<?php if (($current == "properties")&&($this->uri->segment(3)=="new")) { echo ' class="active"'; } ?>><a href="/admin/properties/new"><?php echo $this->lang->line('nav_properties_new'); ?></a></li>
                <li<?php if (($current == "properties")&&($this->uri->segment(3)=="log")) { echo ' class="active"'; } ?>><a href="/admin/properties/log"><?php echo $this->lang->line('nav_properties_log'); ?></a></li>
              </ul>
      </li>
      <li class="dropdown <?php if ($current == "branches") { echo "active"; } ?>">
            <a href="javascript:;" data-toggle="collapse" data-target="#branchesmenu"> <i class="fa fa-map-marker"> </i> <span><?php echo $this->lang->line('nav_branches'); ?></span> <i class="fa fa-fw fa-caret-down"></i></a>
            <ul id="branchesmenu" class="collapse<?php if ($current == "branches") { echo " in"; } ?>">
              <li<?php if (($current == "branches")&&($this->uri->segment(3)=="")) { echo ' class="active"'; } ?>><a href="/admin/branches"><?php echo $this->lang->line('nav_branches_all'); ?></a></li>
              <li<?php if (($current == "branches")&&($this->uri->segment(3)=="new")) { echo ' class="active"'; } ?>><a href="/admin/branches/new"><?php echo $this->lang->line('nav_branches_new'); ?></a></li>
            </ul>
    </li>
