			...
			<div class="panel panel-default">
        		<div class="panel-heading">
                    <h3 class="panel-title">
                        ...
                        <?php echo $this->lang->line('pages_options_header'); ?>
                    </h3>
                </div>
            	<div class="panel-body">
					<div class="form-actions">
                    	<a class="btn btn-primary" data-toggle="modal" href="#slider"><?php echo $this->lang->line('pages_slider_btn'); ?></a> 	<a class="btn btn-primary" data-toggle="modal" href="#search"><?php echo $this->lang->line('pages_search_btn'); ?></a>
					</div>
                </div>
            </div>
        ...
        <div id="search" class="modal fade" role="dialog">
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><?php echo $this->lang->line('pages_search_header'); ?></h4>
              </div>
              <div class="modal-body">
                <div class="form-group">
                 <?php echo form_error('enableSearch', '<div class="alert">', '</div>'); ?>

 						<label class="control-label" for="enableSearch"><?php echo $this->lang->line('pages_search_enable'); ?></label>
                         <?php
 						$att = 'id="enableSearch" class="form-control"';
 						$data = array(
 						  '1'        => $this->lang->line('option_yes'),
 						  '0'         => $this->lang->line('option_no'),
 						);

 						echo form_dropdown('enableSearch', $data, $p['enableSearch'], $att); ?>
