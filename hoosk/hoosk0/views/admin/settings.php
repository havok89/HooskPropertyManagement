...
<div class="container-fluid">
	...
	<div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <hr/>
            <h3><?php echo $this->lang->line('settings_rightmove'); ?></h3>
            <div class="form-group">
					<label class="control-label" for="siteFooter"><?php echo $this->lang->line('settings_rightmoveNetworkID'); ?></label>
					<div class="controls">
                    <?php 	$data = array(
						  'name'        => 'rightmoveNetworkID',
						  'id'          => 'rightmoveNetworkID',
						  'class'       => 'form-control',
						  'value'		=> set_value('rightmoveNetworkID', $s['rightmoveNetworkID'], FALSE)
						);
        ...
        <div class="form-group">
      <label class="control-label" for="rightmovePEMKEY"><?php echo $this->lang->line('settings_rightmovePEMKEY'); ?></label>
      <div class="controls">
                <?php 	$data = array(
          'name'        => 'rightmovePEMKEY',
          'id'          => 'rightmovePEMKEY',
          'class'       => 'form-control',
          'value'		=> set_value('rightmovePEMKEY', $s['rightmovePEMKEY'], FALSE)
        );
    ...
    <div class="form-group">
      <?php echo form_error('rightmoveSendProperties', '<div class="alert alert-danger">', '</div>'); ?>
      <label class="control-label" for="rightmoveSendProperties"><?php echo $this->lang->line('settings_rightmoveSendProperties'); ?></label>
      <div class="controls">
        <?php
          echo form_dropdown('rightmoveSendProperties', $options, set_value('rightmoveSendProperties', $s['rightmoveSendProperties'], FALSE), 'class="form-control"');
         ?>
      </div> <!-- /controls -->
    </div> <!-- /form-group -->
    <div class="form-group">
      <?php echo form_error('rightmoveUseLive', '<div class="alert alert-danger">', '</div>'); ?>
      <label class="control-label" for="rightmoveUseLive"><?php echo $this->lang->line('settings_rightmoveUseLive'); ?></label>
      <div class="controls">
        <?php
          echo form_dropdown('rightmoveUseLive', $options, set_value('rightmoveUseLive',$s['rightmoveUseLive'], FALSE), 'class="form-control"');
         ?>
      </div> <!-- /controls -->
    </div> <!-- /form-group -->

    <div class="form-group">
            <?php echo form_error('rightmovePEMFile', '<div class="alert">', '</div>'); ?>
      <label class="control-label" for="rightmovePEMFile"><?php echo $this->lang->line('settings_rightmovePEMFile'); ?></label>
      <div class="controls">
        <div><?php if ($s['rightmovePEMFile'] != "") { echo "Current file: ".$s['rightmovePEMFile']; } ?></div>
        <?php
          $data = array(
            'name'		=> 'rightmovePEMFile',
            'id'		=> 'rightmovePEMFile',
            'class'		=> 'form-control'
          );
          echo form_upload($data);
...
$(function () {
  if(document.getElementById('rightmove_upload'))
    {
      function prepareUploadRightmove(event)
      {
        files = event.target.files;
        uploadFilesRightmove(event);
      }

      function uploadFilesRightmove(event)
      {
