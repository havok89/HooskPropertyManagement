        ...
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <i class="fa fa-fw fa-pencil"></i>
                	<?php echo $this->lang->line('branches_edit_header'); ?>
                </li>
            </ol>
        </div>
    </div>
        ...
        <div class="panel panel-default">
         ...
         <div class="panel-body">
           <div class="alert alert-info"><?php echo $this->lang->line('branches_new_required'); ?></div>
			...
			echo form_open(BASE_URL.'/admin/branches/edited/'.$this->uri->segment(4), $attr); ?>
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <?php 	$data = array(
                    ...
                    'id'          => 'branchName',
                    'class'       => 'form-control',
                    'value'		=> set_value('branchName',$branch[0]['branchName'], FALSE)
                  );
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <?php 	$data = array(
                    ...
                    'value'		=> set_value('branchURL',$branch[0]['branchURL'], FALSE)
                  );
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <?php 	$data = array(
                    ...
                    'id'          => 'branchAddress',
                    'class'       => 'form-control',
                    'value'		=> set_value('branchAddress',$branch[0]['branchAddress'], FALSE)
                  );
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <?php 	$data = array(
                    ...
                    'id'          => 'branchTelephone',
                    'class'       => 'form-control',
                    'value'		=> set_value('branchTelephone',$branch[0]['branchTelephone'], FALSE)
                  );
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <?php 	$data = array(
                    ...
                    'id'          => 'branchEmail',
                    'class'       => 'form-control',
                    'value'		=> set_value('branchEmail',$branch[0]['branchEmail'], FALSE)
                  );
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <?php 	$data = array(
                    ...
                    'class'       => 'form-control',
                    'value'		=> set_value('branchRightmoveID',$branch[0]['branchRightmoveID'], FALSE)
                  );
