...
$route['admin/properties/log'] = "admin/properties/log";
$route['admin/properties/new'] = "admin/properties/addProperty";
$route['admin/properties/new/add'] = "admin/properties/confirm";
$route['admin/properties/delete/(:any)'] = "admin/properties/delete";
$route['admin/properties/edit/(:any)'] = "admin/properties/editProperty";
$route['admin/properties/edited/(:any)'] = "admin/properties/edited";
$route['admin/properties/(:any)'] = "admin/properties";
$route['admin/properties/upload'] = "admin/properties/upload";
$route['admin/branches'] = "admin/branches";
$route['admin/branches/new'] = "admin/branches/addBranch";
$route['admin/branches/new/add'] = "admin/branches/confirm";
$route['admin/branches/delete/(:any)'] = "admin/branches/delete";
$route['admin/branches/edit/(:any)'] = "admin/branches/editBranch";
$route['admin/branches/edited/(:any)'] = "admin/branches/edited";
$route['admin/branches/(:any)'] = "admin/branches";
$route['admin/agent_ref/check/(:any)'] = "admin/properties/refcheck";
$route['submit/search'] = "hoosk_default/submitSearch";
$route['search/results/(:any)'] = "hoosk_default/searchResults";
$route['property/(:any)'] = "hoosk_default/propertyDetails";
